...
public class Day20Part2
{
    ...
    private class Day20Part2Tests
    {
        [Test] public void TestData() =>
            Assert.That(new Day20Part2().Run(File.ReadAllLines("Day20Part2/testdata.txt")), Is.EqualTo(0));

        [Test] public void Data() =>
            Assert.That(new Day20Part2().Run(File.ReadAllLines("Day20Part2/data.txt")), Is.EqualTo(1000697));
    }
}