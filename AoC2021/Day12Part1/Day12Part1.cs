...
public class Day12Part1
{
    ...
    private class Tests
    {
        ...
        public void TestData()
        {
            ...
            Assert.That(sut.Run(data), Is.EqualTo(10));
        }
        ...
        public void TestData2()
        {
            ...
            var sut = new Day12Part1();
            Assert.That(sut.Run(data), Is.EqualTo(19));
        }
        ...
        public void TestData3()
        {
            ...
            var sut = new Day12Part1();
            Assert.That(sut.Run(data), Is.EqualTo(226));
        }
        ...
        public void Data()
        {
            ...
            var sut = new Day12Part1();
            Assert.That(sut.Run(data), Is.EqualTo(3761));
        }
    }
}